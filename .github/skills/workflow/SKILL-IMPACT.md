...
|---|---|---|---|---|---|
| 2026-09-12 | workflow | v2.02: checks executed at plan time with pre-edit result; presence-over-absence and occurrence-count rules; cycle-scoped patch/re-review cards; grep instead of rg; doc-only runs skip the suite on an empty receipt-rule diff; not-found = failed check | run foundry-semantic-boundaries (review + patch plan) | 3 runs | trialing |
